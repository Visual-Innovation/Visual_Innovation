...
<body>
    ...
    <!--Sobre-->
    <div id="containerSobre" class="container-fluid mt-5 pt-1">
        <div id="sobre_container" class="row justify-content-evenly">
            <img class="col-lg-4 border border-dark" src="../assets/img_historia.jpg" alt="img" srcset="">
            <div id="text_sobre" class="text-sm-center col-md-7 order-last">
    ...
    <!--Carousel-->
    <div id="sobre_car" class="container-fluid mt-5 pt-4 pb-2">
        <div class="owl-carousel owl-theme">
            <div class="ms-2 me-2">
                <div class="card">
                    <img data-src="../assets/expocosmetics-g0e06cec31_1280.jpg" class="card-img-top owl-lazy">
                </div>
            </div>
            <div class="ms-2 me-2">
                <div class="card">
                    <img data-src="../assets/man-cutting-the-hair-on-the-person-sitting-on-the-chair-1805600.jpg"
                        class="card-img-top owl-lazy">
                </div>
            </div>
            <div class="ms-2 me-2">
                <div class="card">
                    <img data-src="../assets/wedding-g888517d16_1280.jpg" class="card-img-top owl-lazy">
                </div>
            </div>
            <div class="ms-2 me-2">
                <div class="card">
