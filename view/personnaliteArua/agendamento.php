...
<doctype html>
    ...
    <head>
        ...
        <script src="../../js/script.fullcalendar.js"></script>
    ...
    <body>
        ...
        <!--Agendamento-->
        <div id="ContainerAgenda" class="container-fluid p-0 mb-5">
            <div class=" d-flex align-items-center justify-content-center 
            border-bottom border-dark">
                <h1 class=" ms-4">Agendar Serviço</h1>
            </div>

            <div class="row m-0 d-flex ">
                <div id="servicos" class="col-xl-3 col-lg-12 border border-dark">
                    <h2>Serviços</h2>
                    <div class="search-box">
                        <input type="text" class="search-txt" class="me-4">
                        <button type="submit"><i class="fas fa-search"></i></button>
                    </div>
                    <div id="dServico" class="d-flex align-items-center justify-content-between">
                        <p class="text-center">Unha</p>
                        <p>R$100.00</p>
                    </div>
                </div>

                <div id="agenda" class="col-9 col-md-10 col-lg-10 col-xl-8  border border-dark ">
                    <div id="imgServicos" class="img-fluid border border-dark">
                        <img src="" alt="img">
                    </div>

                    <div id="descricaoServico" class="border border-dark">
                        <h2>Descrição</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores illum incidunt amet eius veniam recusandae similique. Placeat quos molestias cupiditate, doloremque sed quas numquam nesciunt, quod et, optio voluptatem ullam.
                        </p>
                    ...
                    <div id="agendar" class="modal fade" tabindex="-1">
