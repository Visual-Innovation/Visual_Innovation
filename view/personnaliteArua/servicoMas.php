    ...
    <body onload="loading()">
        ...
        <div class="content">
            ...
            <div class="container-fluid p-0">
                <!--Banner-->
                <div id="imgServicoMas" class="w-100 border border-dark"></div>
                <!--Banner-->
            ...
            <div id="cardServicos" class="container">
                ...
                <div id="card-servico" class="border border-dark imgMM">
                    <div id="servico" class="border border-dark p-3">
                        ...
                        <div id="iconServ">
                            <img src="/assets/Icons/Icon_ManicureMasc.png" alt="img" srcset="">
                        </div>
                        <hr class="m-5">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="agendamentoMasc.html" class="btn btn-warning">
                                Agendar
                            </a>
                        </div>
                    </div>
                ...
                <div id="card-servico" class="border border-dark imgCM">
                    <div id="servico" class="border border-dark p-3">
                        ...
                        <div id="iconServ">
                            <img src="/assets/Icons/Icon_CabeloMasc.png" alt="img" srcset="">
                        </div>
                        <hr class="m-5">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="agendamentoMasc.html" class="btn btn-warning">
                ...
                <div id="card-servico" class="border border-dark imgEM">
                    <div id="servico" class="border border-dark p-3">
                        ...
                        <div id="iconServ">
                            <img src="/assets/Icons/Icon_EsteticaMasc.png" alt="img" srcset="">
                        </div>
                        <hr class="m-5">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="agendamentoMasc.html" class="btn btn-warning">
