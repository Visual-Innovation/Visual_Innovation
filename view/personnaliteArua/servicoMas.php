<doctype html>
    ...
    <body>
        ...
        <div class="container-fluid p-0">
            <div id="imgServicoMas" class="w-100 border border-dark">
            </div>
        ...
        <div id="cardServicos" class="container">
            ...
            <div id="card-servico" class="border border-dark imgMM">
                <div id="servico" class="border border-dark p-3">
                    <h1 class="text-center ">Manicure</h1>
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/ManicureMasc.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="agendamento.php" class="btn btn-warning">
                            Agendar
                        </a>
                    </div>
                </div>
            ...
            <div id="card-servico" class="border border-dark imgCM">
                <div id="servico" class="border border-dark p-3">
                    <h1 class="text-center">Cabelo</h1>
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/CabeloMasc.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="agendamento.php" class="btn btn-warning">
            ...
            <div id="card-servico" class="border border-dark imgEM">
                <div id="servico" class="border border-dark p-3">
                    <h1 class="text-center">Estética</h1>
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/EsteticaMasc.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="agendamento.php" class="btn btn-warning">
