<doctype html>
    ...
    <body>
        ...
        <div class="container-fluid p-0">
            <div id="imgServicoFem" class="w-100 border border-dark">
            </div>
        ...
        <div id="cardServicos" class="container">
            ...
            <div id="card-servico" class="border border-dark imgMF">
                <div id="servico" class="border border-dark p-3">
                    ...
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/ManicureFem.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
            ...
            <div id="card-servico" class="border border-dark imgCF">
                <div id="servico" class="border border-dark p-3">
                    ...
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/CabeloFem.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="agendamento.php" class="btn btn-warning">
            ...
            <div id="card-servico" class="border border-dark imgEF">
                <div id="servico" class="border border-dark p-3">
                    ...
                    <div id="iconServ">
                        <img src="../../assets/Servicos/Icons/EsteticaFem.png" alt="img" srcset="">
                    </div>
                    <hr class="m-5">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="agendamento.php" class="btn btn-warning">
